 ...
 * @param {Array} inp.nodes 輸入節點陣列,每項為一般節點 { id, label, cls, group? } 或富節點 { id, title, items, cls, group? };cls 為色票鍵(見 src/common/palette.mjs),結尾 G/G2 者為群組容器,group 為所屬容器 id(容器可巢狀);label 過寬會自動斷行,亦可用 '\n' 強制換行(p10 支援,含群組/菱形標籤;其他產線依引擎行為)
 * @param {Array} inp.edges 輸入邊陣列,每項為 { from, to, label?, kind? },kind 給 'dashed' 為虛線;label 同樣支援 '\n' 強制換行(p10)
